...
A low μ was required for a stable horseshoe, and after various attempts to reproduce one at μ = 0.01, the trajectory would either stabilize into a tadpole or become chaotic. This was fixed after changing μ to 0.001. Both values of μ are under the critical ratio; however, 0.01 was insufficient, since the window for horseshoes was difficult to locate, so a smaller mass ratio was used for easier access to horseshoe orbits.
